...
Export a named connector from `~/.emerge/connectors/<name>/` along with its intent registry entries into a portable zip file.
...
2. Run:
   ...
   ```
3. Report the result:
   - On success: show connector name, output file path, number of files, number of intent registry entries included.
