...
class PipelineCrystallizer:
    ...
    def crystallize(
        ...
        *,
        ...
        from scripts.policy_config import atomic_write_json, derive_profile_token, load_json_object, resolve_connector_root
        ...
        _registry = load_json_object(_registry_path, root_key="pipelines")
        ...
        if intent_signature in _registry["pipelines"]:
            ...
            atomic_write_json(_registry_path, _registry)
